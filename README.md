...
https://purecontrol-frontend.vercel.app/downloads/PURECONTROL-v1.9-release.apk
...
Pour activer les push en production, ajouter le fichier Firebase Android `google-services.json` dans `android/app/`, definir `VITE_ENABLE_FCM=true`, puis reconstruire l'APK. Le package Android Firebase doit etre `cm.purecontrol.app`.
